...
/**
 * Variation of the Agenda component with infinite scroll support in both directions.
 * 
 * @author Ville Venäläinen - @villevenalainen based on work done by Tautvilas Mecinskas - @tautvilas
 */
  ...
  renderReservations() {
    return (
      <ReservationsList
        ...
        onReadDayReservations={this.props.onReadDayReservations}
        onScroll={() => {}}
        ref={(c) => this.list = c}
